...
public class JedisShiroCache<K, V> implements Cache<K, V> {
    ...
    public V get(K key) throws CacheException {
        ...
        try {
            ...
            LoggerUtil.error(SELF, "get value by cache throw exception",e);
        }
    ...
    public V put(K key, V value) throws CacheException {
        ...
        try {
            ...
            LoggerUtil.error(SELF, "put cache throw exception",e);
        }
        return previos;
    }
    ...
    public V remove(K key) throws CacheException {
        ...
        try {
            ...
            LoggerUtil.error(SELF, "remove cache  throw exception",e);
        }
        return previos;
    }
