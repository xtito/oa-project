...
<ul class="layui-tab-title site-demo-title">
    ...
    <li class="tab-li ${param.active == '2' ? 'layui-this' : ''}"><a class="" data-url="">在线用户</a></li>
    <li class="tab-li ${param.active == '3' ? 'layui-this' : ''}"><a class="" data-url="${ctx}/static/pages/sys/user/add_user.jsp">添加用户</a></li>
