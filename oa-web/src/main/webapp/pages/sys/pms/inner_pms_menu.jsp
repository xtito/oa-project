...
<ul class="layui-tab-title site-demo-title">
    <li class="tab-li ${param.active == '1' ? 'layui-this' : ''}">
        <a data-url="${ctx}/pages/sys/pms/user_role_list.jsp">
    ...
    <li class="tab-li ${param.active == '2' ? 'layui-this' : ''}">
        <a data-url="${ctx}/pages/sys/pms/role_pms_list.jsp">
    ...
    <li class="tab-li ${param.active == '3' ? 'layui-this' : ''}">
        <a class="trigger-pms-list" data-url="${ctx}/pages/sys/pms/sys_permission.jsp">
    ...
    <li class="tab-li ${param.active == '4' ? 'layui-this' : ''}">
        <a data-url="${ctx}/pages/sys/pms/add_permission.jsp">
